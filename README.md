...
# Create vue project with electron
...
create **main.js** like this repository
...
```
{
    ...
    "scripts": {
        "packager": "electron-packager ./ TestAgent --platform=win32 --arch=x64 --icon=./dist/favicon.ico --out=./out --overwrite",
        "packager-linux": "electron-packager ./ TestAgent --platform=linux --arch=x64 --icon=./dist/favicon.ico --out=./out --overwrite",
        "packager-mac": "electron-packager ./ TestAgent --platform=darwin --arch=x64 --icon=./dist/favicon.ico --out=./out --overwrite",
        ...
    }
}
```
